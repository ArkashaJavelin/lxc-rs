...
fn template(cm: &str, args: Vec<String>, _err_message: &str) {
...
pub mod Image {
   ...
   pub fn refresh_image(image: String) {
      template("lxc", vec!["image".to_string(), "refresh".to_string(), image.to_strnig()], "Failed to refresh a current image");
   }
...
pub fn set_storage_changes(storage: String, key: String, value: String) {
   template("lxc", vec!["storage".to_string(), "set".to_string(), storage.to_string(), key.to_string(), value.to_string()], "Failed to ....");
}

pub fn del_storage(storage: String) {
   template("lxc", vec!["storage".to_string(), "delete".to_string(), storage.to_string()], "Failed...");
}

pub fn get_volumes_by_storage(storage: String) {
   template("lxc", vec!["storage".to_string(), "volume".to_string(), "list".to_string(), storage.to_string()], "Failed...");
}

pub fn create_volume(storage: String, name: String) {
   template("lxc", vec!["storage".to_string(), "volume".to_string(), "create".to_string(), storage.to_string(), name.to_string()], "Failed....");
}
...
pub fn delete_volume_lxc(storage: String, volume: String) {
...
pub fn get_config_devices() {
   template("lxc", vec!["config".to_string(), "device".to_string()], "Failed to get config devices");
}
